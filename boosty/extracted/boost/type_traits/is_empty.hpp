...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::ddboost::detail::empty_helper<cvt,::ddboost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::ddboost::detail::empty_helper<
                  cvt
                , ::ddboost::is_class<T>::value
                , ::ddboost::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::ddboost::detail::is_empty_impl<T>::value> {};
