...
namespace ddboost { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public ddboost::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public ddboost::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::ddboost::has_trivial_constructor<T> {};
