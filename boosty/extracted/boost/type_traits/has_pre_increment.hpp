...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      /* bool */\
      ::ddboost::is_same< bool, Rhs_nocv >::value || \
      /* void* */\
      (\
      ...
      (\
         ...
         ::ddboost::is_const< Rhs_noref >::value\
      )||\
      /* Arrays */ \
      ::ddboost::is_array<Rhs_noref>::value\
      )
...
namespace ddboost {
   ...
   template <>
   struct has_pre_increment<bool, ddboost::binary_op_detail::dont_care> : public false_type {};
   template <>
