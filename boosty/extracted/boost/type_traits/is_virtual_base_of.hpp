...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename ddboost::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      ddboost::integral_constant<
      bool,
      ddboost::is_base_of<T, U>::value &&
   ...
   {
      typedef ddboost::integral_constant<bool, (ddboost::is_base_of<Base, Derived>::value && !ddboost::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::ddboost::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
