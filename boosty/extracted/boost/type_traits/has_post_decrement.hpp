...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      /* bool */\
      ::ddboost::is_same< bool, Lhs_nocv >::value || \
      /* void* */\
      (\
      ...
      /* Arrays */ \
      ::ddboost::is_array<Lhs_noref>::value\
      )
...
namespace ddboost {
   ...
   template <>
   struct has_post_decrement<bool, ddboost::binary_op_detail::dont_care> : public false_type {};
   template <>
