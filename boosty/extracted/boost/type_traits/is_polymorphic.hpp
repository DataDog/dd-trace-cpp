...
{
   typedef is_polymorphic_selector< ::ddboost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::ddboost::detail::is_polymorphic_imp<T>::value> {};
