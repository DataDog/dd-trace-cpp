...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::ddboost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::ddboost::integral_constant<std::size_t, ::ddboost::detail::extent_imp<T,N>::value>
{
};
