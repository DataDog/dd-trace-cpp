...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::ddboost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::ddboost::is_class<B>::value,
       ::ddboost::is_class<D>::value,
       ::ddboost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::ddboost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::ddboost::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
