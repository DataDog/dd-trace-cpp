...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ...
         (! \
            ( \
               ::ddboost::is_base_of< Lhs_noptr, Rhs_noptr >::value || \
               ::ddboost::is_base_of< Rhs_noptr, Lhs_noptr >::value || \
               ::ddboost::is_same< Lhs_noptr, Rhs_noptr >::value || \
      ...
      (\
         ::ddboost::type_traits_detail::is_likely_stateless_lambda<Lhs_noref>::value\
      )\
   )
