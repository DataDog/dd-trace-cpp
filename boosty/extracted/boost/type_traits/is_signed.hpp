...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::ddboost::detail::is_signed_values<T>::minus_one  > ddboost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::ddboost::detail::is_signed_select_helper< ::ddboost::is_integral<T>::value || ::ddboost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, ddboost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::ddboost::long_long_type> : public true_type{};
template <> struct is_signed<const ::ddboost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::ddboost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::ddboost::long_long_type> : public true_type{};

template <> struct is_signed< ::ddboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::ddboost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::ddboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::ddboost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
