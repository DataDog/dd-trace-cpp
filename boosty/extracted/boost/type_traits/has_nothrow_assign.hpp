...
namespace ddboost {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(ddboost::declval<typename add_reference<T>::type>() = ddboost::declval<typename add_reference<T const>::type>()); };
