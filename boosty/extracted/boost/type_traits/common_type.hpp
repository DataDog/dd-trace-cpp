...
template<class T> struct common_type<T>: ddboost::decay<T>
{
   BOOST_STATIC_ASSERT_MSG(::ddboost::is_complete<T>::value || ::ddboost::is_void<T>::value || ::ddboost::is_array<T>::value, "Arguments to common_type must both be complete types");
};
...
template<class T1, class T2> using builtin_common_type = typename ddboost::decay<decltype( ddboost::declval<bool>()? ddboost::declval<T1>(): ddboost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( ddboost::declval<bool>()? ddboost::declval<T1>(): ddboost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename ddboost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: ddboost::decay<decltype( ddboost::declval<bool>()? ddboost::declval<T1>(): ddboost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename ddboost::decay<T1>::type, class T2d = typename ddboost::decay<T2>::type> struct common_type_decay_helper: ddboost::common_type<T1d, T2d>
{
};
...
{
   BOOST_STATIC_ASSERT_MSG(::ddboost::is_complete<T1>::value || ::ddboost::is_void<T1>::value || ::ddboost::is_array<T1>::value, "Arguments to common_type must both be complete types");
   BOOST_STATIC_ASSERT_MSG(::ddboost::is_complete<T2>::value || ::ddboost::is_void<T2>::value || ::ddboost::is_array<T2>::value, "Arguments to common_type must both be complete types");
};
