...
{
   BOOST_STATIC_CONSTANT(bool, value = (::ddboost::detail::is_unsigned_values<T>::minus_one > ::ddboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::ddboost::detail::is_unsigned_select_helper< ::ddboost::is_integral<T>::value || ::ddboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, ddboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::ddboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::ddboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::ddboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::ddboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::ddboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::ddboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::ddboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::ddboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
