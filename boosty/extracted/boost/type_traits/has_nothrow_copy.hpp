...
struct has_nothrow_copy_constructor_imp : public ddboost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public ddboost::integral_constant<bool, noexcept(T(ddboost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, ddboost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::ddboost::has_trivial_copy<T>::value>{};
