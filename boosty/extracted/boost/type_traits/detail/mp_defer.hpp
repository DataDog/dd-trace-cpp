...
struct mp_valid_impl
{
    ...
    static ddboost::true_type check_s(int);

    template<template<class...> class>
    static ddboost::false_type check_s(...);
...
template<template<class...> class F, class... T> using mp_defer = typename ddboost::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
