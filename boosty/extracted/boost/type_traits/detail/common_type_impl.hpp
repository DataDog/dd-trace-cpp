...
{
    BOOST_STATIC_CONSTANT( bool, ct = ddboost::is_class<T>::value || ddboost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = ddboost::is_class<U>::value || ddboost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public ddboost::conditional<

    ddboost::is_convertible<T, U>::value && !ddboost::is_convertible<U, T>::value,
    ddboost::type_identity<U>,

    typename ddboost::conditional<

        ddboost::is_convertible<U, T>::value && !ddboost::is_convertible<T, U>::value,
        ddboost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public ddboost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public ddboost::conditional<
    ddboost::is_pointer<T>::value || ddboost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public ddboost::conditional<
    ddboost::is_member_pointer<T>::value || ddboost::is_member_pointer<U>::value,
