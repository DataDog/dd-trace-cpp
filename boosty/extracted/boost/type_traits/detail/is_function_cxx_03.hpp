...
{
    template< typename T > struct result_
        : public ::ddboost::type_traits::is_function_ptr_helper<T*> {};
};

template <typename T>
struct is_function_impl
    : public is_function_chooser< ::ddboost::is_reference<T>::value >
...
#pragma warning(disable:6334)
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(::ddboost::type_traits::is_function_ptr_tester(t))
...
#else
template <class T> struct is_function : integral_constant<bool, ::ddboost::detail::is_function_impl<T>::value> {};
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
