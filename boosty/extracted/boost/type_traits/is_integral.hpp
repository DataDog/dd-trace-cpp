...
template<> struct is_integral< ::ddboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::ddboost::long_long_type> : public true_type{};
...
template<> struct is_integral<ddboost::int128_type> : public true_type{};
template<> struct is_integral<ddboost::uint128_type> : public true_type{};
#endif
