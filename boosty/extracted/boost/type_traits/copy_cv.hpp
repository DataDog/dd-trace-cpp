...
private:
    ...
    typedef typename ddboost::conditional<ddboost::is_const<U>::value, typename ddboost::add_const<T>::type, T>::type CT;

public:

    typedef typename ddboost::conditional<ddboost::is_volatile<U>::value, typename ddboost::add_volatile<CT>::type, CT>::type type;
};
