...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename ddboost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::ddboost::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename ddboost::detail::remove_pointer_imp2<T>::type type; };
