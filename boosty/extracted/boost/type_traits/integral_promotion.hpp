...
// 4.5/2
template <class T> struct need_promotion : public ddboost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(ddboost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(ddboost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, ddboost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, ddboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, ddboost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, ddboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (ddboost::type_traits::detail::promoted_index<T>::value)
      , (ddboost::is_const<T>::value)
      , (ddboost::is_volatile<T>::value)
      >::type type;
};
...
{
private:
   typedef ddboost::type_traits::detail::need_promotion<typename remove_cv<T>::type> tag_type;
public:
   typedef typename ddboost::type_traits::detail::integral_promotion<T, tag_type::value>::type type;
};
