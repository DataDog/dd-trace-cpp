...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<ddboost::is_void<From>, ddboost::is_function<To>, ddboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(ddboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::ddboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::ddboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::ddboost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static ddboost::type_traits::no_type _m_check(any_conversion ...);
    static ddboost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( ddboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::ddboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( ddboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::ddboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::ddboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::ddboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::ddboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::ddboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::ddboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::ddboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::ddboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::ddboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::ddboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::ddboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::ddboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::ddboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::ddboost::is_function<typename ::ddboost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::ddboost::detail::is_convertible_basic_impl<From,To>::value && ! ::ddboost::is_array<To>::value && ! ::ddboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::ddboost::detail::is_convertible_basic_impl<From, To>::value && !::ddboost::is_array<To>::value && !::ddboost::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::ddboost::is_arithmetic<From>::value, 
      ::ddboost::is_arithmetic<To>::value,
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::ddboost::detail::is_convertible_impl_dispatch<From, To>::value> 
{
   BOOST_STATIC_ASSERT_MSG(ddboost::is_complete<To>::value || ddboost::is_void<To>::value || ddboost::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(ddboost::is_complete<From>::value || ddboost::is_void<From>::value || ddboost::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(ddboost::is_complete<From>::value || ddboost::is_void<From>::value || ddboost::is_array<From>::value || ddboost::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif
