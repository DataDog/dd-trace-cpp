...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::ddboost::detail::alignment_logic<
            sizeof(::ddboost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
template <class T> struct alignment_of : public integral_constant<std::size_t, ::ddboost::detail::alignment_of_impl<T>::value>{};
