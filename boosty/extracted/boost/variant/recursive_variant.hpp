...
struct substitute<
      ::ddboost::variant<
        ...
        >
    , RecursiveVariant
    , ::ddboost::recursive_variant_
      BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(Arity)
    >
{
    typedef ::ddboost::variant<
          recursive_flag< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        > type;
};
...
struct substitute<
      ::ddboost::variant<
          ::ddboost::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::ddboost::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::ddboost::is_same<mpl::_1, mpl::_2> >
        , ::ddboost::variant<
              ::ddboost::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::ddboost::variant< over_sequence<types> >
        >::type type;
};
...
template <
    ...
    >
struct substitute<
      ::ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >
    , RecursiveVariant
    , ::ddboost::recursive_variant_
      BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(Arity)
    >
...
public: // metafunction result
    ...
    typedef ::ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
