...
#   include <boost/move/utility_core.hpp> // for ddboost::move, ddboost::forward
#endif
...
public: // visitor interfaces
    ...
    {
        return visitor_(::ddboost::move(value1_), ::ddboost::forward<Value2>(value2));
    }
    ...
    operator()(Value2&& value2)
    {
        return visitor_(value1_, ::ddboost::forward<Value2>(value2));
    }
...
public: // visitor interfaces
    ...
    operator()(Value1&& value1)
    {
        apply_visitor_binary_invoke<
              Visitor
            , Value1
            , ! ::ddboost::is_lvalue_reference<Value1>::value
            > invoker(visitor_, value1);

        return ddboost::apply_visitor(invoker, ::ddboost::move(visitable2_));
    }
    ...
    operator()(Value1&& value1)
    {
        ...
        return ddboost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::ddboost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2, ! ::ddboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);

    return ddboost::apply_visitor(unwrapper, ::ddboost::forward<Visitable1>(visitable1));
}
...
apply_visitor( Visitor& visitor, Visitable1& visitable1, Visitable2& visitable2)
{
    ...
    return ddboost::apply_visitor(unwrapper, visitable1);
}
...
{
    ::ddboost::detail::variant::apply_visitor_binary_unwrap<
          const Visitor, Visitable2, ! ::ddboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
    ...
    >::type = true)
{
    ::ddboost::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2, ! ::ddboost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
