...
public: // std::exception implementation
    ...
    {
        return "ddboost::bad_get: "
               "failed value get using ddboost::get";
    }
...
public: // visitor interfaces
    ...
    {
        return ddboost::addressof(operand);
    }
...
relaxed_get(
      ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
relaxed_get(
      const ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    ) BOOST_NOEXCEPT
{
...
{
    typedef typename add_pointer<U>::type U_ptr;
    U_ptr result = relaxed_get<U>(ddboost::addressof(operand));

    if (!result)
        ddboost::throw_exception(bad_get());
    return *result;
}
...
{
    typedef typename add_pointer<const U>::type U_ptr;
    U_ptr result = relaxed_get<const U>(ddboost::addressof(operand));
    ...
    ) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        (ddboost::detail::variant::holds_element<ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "ddboost::variant does not contain specified type U, "
        "call to ddboost::get<U>(ddboost::variant<T...>*) will always return NULL"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (ddboost::detail::variant::holds_element<ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "ddboost::variant does not contain specified type U, "
        "call to ddboost::get<U>(const ddboost::variant<T...>*) will always return NULL"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (ddboost::detail::variant::holds_element<ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "ddboost::variant does not contain specified type U, "
        "call to ddboost::get<U>(ddboost::variant<T...>&) will always throw ddboost::bad_get exception"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (ddboost::detail::variant::holds_element<ddboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "ddboost::variant does not contain specified type U, "
        "call to ddboost::get<U>(const ddboost::variant<T...>&) will always throw ddboost::bad_get exception"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (!ddboost::is_lvalue_reference<U>::value),
        "remove ampersand '&' from template type U in ddboost::get<U>(ddboost::variant<T...>&&) "
    );
