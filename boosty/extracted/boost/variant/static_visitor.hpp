...
template <typename R = ::ddboost::detail::static_visitor_default_return>
...
template< typename T > struct is_static_visitor
  : public ::ddboost::integral_constant<bool,(::ddboost::detail::is_static_visitor_impl<T>::value)>
{
public:
