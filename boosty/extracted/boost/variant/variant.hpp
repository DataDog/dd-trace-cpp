...
struct add_alignment
{
    ...
    struct apply
        : mpl::size_t<
              ::ddboost::integer::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value
                , ::ddboost::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer ddboost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for ddboost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<ddboost::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename ddboost::mpl::find_if<
        Types, mpl::not_<ddboost::is_nothrow_move_constructible<ddboost::mpl::_1> >
    >::type iterator_t;

    typedef typename ddboost::mpl::end<Types>::type end_t;
    typedef typename ddboost::is_same<
        iterator_t, end_t
    >::type type;
};
...
struct is_variant_move_noexcept_assignable {
    typedef typename ddboost::mpl::find_if<
        Types, mpl::not_<ddboost::is_nothrow_move_assignable<ddboost::mpl::_1> >
    >::type iterator_t;
...
struct is_constructible_ext:
    ddboost::mpl::or_<
        ddboost::is_constructible<
            T1,
            T2
        >,
        ddboost::is_constructible<
            T1,
            typename ddboost::add_lvalue_reference<T2>::type
        >
    >
{};
...
struct is_variant_constructible_from:
    ddboost::mpl::not_< ddboost::is_same<
        typename ddboost::mpl::find_if<
            Types,
            is_constructible_ext<ddboost::mpl::_1, T>
        >::type,
        typename ddboost::mpl::end<Types>::type
    > >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >:
    ddboost::is_same<
        typename ddboost::mpl::find_if<
            typename ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types,
            mpl::not_< is_variant_constructible_from< ddboost::mpl::_1, Types> >
        >::type,
        typename ddboost::mpl::end< typename ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types >::type
    >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< const ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& , Types >:
    is_variant_constructible_from<ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const && , Types >:
    is_variant_constructible_from<ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
public: // metafunction result
    ...
    typedef ::ddboost::aligned_storage<
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::ddboost::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
    void internal_visit(ddboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }

    template <typename T>
    void internal_visit(const ddboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }
...
public: // internal visitor interface
    ...
    void internal_visit(ddboost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::ddboost::detail::variant::move(operand.get()) );
    }

    template <typename T>
    void internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(ddboost::declval<T>())))
    {
        new(storage_) T(::ddboost::detail::variant::move(operand));
    }
};
#endif
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::ddboost::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
    }
    ...
    void internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::ddboost::detail::variant::move(*static_cast<T* >(rhs_storage_));
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::ddboost::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::ddboost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::ddboost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::ddboost::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const ddboost::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const ddboost::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return ddboost::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces
    ...
    {
        return visitor_(::ddboost::move(operand));
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
    result_type internal_visit(ddboost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const ddboost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(ddboost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const ddboost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(ddboost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const ddboost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::ddboost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant()
              ...
              BOOST_NOEXCEPT_IF(ddboost::has_nothrow_constructor<internal_T0>::value)
#endif
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(ddboost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const ddboost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(ddboost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const ddboost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(ddboost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const ddboost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename T>
    typename ddboost::enable_if<ddboost::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename ddboost::enable_if<ddboost::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename ddboost::enable_if<ddboost::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    typename ddboost::enable_if<mpl::or_<
        ddboost::is_same<ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        ddboost::detail::variant::is_variant_constructible_from<ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    typename ddboost::enable_if<mpl::or_<
        ddboost::is_same<ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        ddboost::detail::variant::is_variant_constructible_from<const ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          const ddboost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);
...
public: // structors, cont.
    ...
    variant(const T& operand,
        typename ddboost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< ddboost::is_same<T, variant> >,
                ddboost::detail::variant::is_variant_constructible_from<const T&, internal_types>
            >,
            ddboost::is_same<T, ddboost::recursive_variant_> >,
            bool >::type = true)
    {
    ...
    variant(
        ...
        , typename ddboost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< is_const<T> >,
                mpl::not_< ddboost::is_same<T, variant> >,
                ddboost::detail::variant::is_variant_constructible_from<T&, internal_types>
            >,
            ddboost::is_same<T, ddboost::recursive_variant_> >,
            bool >::type = true
        )
    ...
    variant(T&& operand,
        typename ddboost::enable_if<mpl::or_<
            mpl::and_<
                ddboost::is_rvalue_reference<T&&>,
                mpl::not_< ddboost::is_const<T> >,
                mpl::not_< ddboost::is_same<T, variant> >,
                ddboost::detail::variant::is_variant_constructible_from<T&&, internal_types>
            >,
            ddboost::is_same<T, ddboost::recursive_variant_> >,
...
public: // queries
    ...
    const ddboost::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::ddboost::mpl::is_sequence<Types>::value ));
    typedef typename ddboost::mpl::insert_range<
      ddboost::mpl::list<>
    , ddboost::mpl::end< ddboost::mpl::list<> >::type
    , Types
