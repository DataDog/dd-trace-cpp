...
//
template <class T>          struct is_constructible<recursive_wrapper<T>, T>                            : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T>                      : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, T&>                           : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T&>                     : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T> >        : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T> >  : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T>& >       : ddboost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T>& > : ddboost::true_type{};

template <class T, class U> struct is_constructible<recursive_wrapper<T>, U >                           : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U >                     : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, U& >                          : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U& >                    : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U> >        : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U> >  : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U>& >       : ddboost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U>& > : ddboost::false_type{};
...
template <class T> struct is_nothrow_move_constructible<recursive_wrapper<T> > : ddboost::false_type{};
...
template< typename T > struct is_recursive_wrapper
    : public ::ddboost::integral_constant<bool,(::ddboost::detail::is_recursive_wrapper_impl<T>::value)>
{
public:
