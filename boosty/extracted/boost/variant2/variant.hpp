...
BOOST_NORETURN inline void throw_bad_variant_access()
{
    ...
    ddboost::throw_exception( bad_variant_access() );
...
{
    ddboost::ulong_long_type hv = ( ddboost::ulong_long_type( 0xCBF29CE4 ) << 32 ) + 0x84222325;
    ddboost::ulong_long_type const prime = ( ddboost::ulong_long_type( 0x00000100 ) << 32 ) + 0x000001B3;
...
{
    return mp11::mp_with_index<sizeof...(T)>( v.index(), detail::hash_value_L< ddboost::hash, variant<T...> >{ v } );
}
...
template<class... T> struct hash< ::ddboost::variant2::variant<T...> >: public ::ddboost::variant2::detail::std_hash_impl< ::ddboost::variant2::variant<T...> >
{
};

template<> struct hash< ::ddboost::variant2::monostate >
{
    std::size_t operator()( ::ddboost::variant2::monostate const & v ) const
    {
        return hash_value( v );
    }
};
