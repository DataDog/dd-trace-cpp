...
// std::string ddboost::core::type_name<T>()
//
...
{
    std::string r = ddboost::core::demangle( n );
...
template<> struct tn_holder<ddboost::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<ddboost::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<ddboost::int128_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<ddboost::uint128_type>
{
    static std::string type_name( std::string const& suffix )
    {
