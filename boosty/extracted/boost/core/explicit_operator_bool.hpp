...
#define BOOST_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE operator ddboost::detail::unspecified_bool_type () const\
    {\
        return (!this->operator! () ? &ddboost::detail::unspecified_bool::true_value : (ddboost::detail::unspecified_bool_type)0);\
    }

#define BOOST_EXPLICIT_OPERATOR_BOOL_NOEXCEPT()\
    BOOST_FORCEINLINE operator ddboost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &ddboost::detail::unspecified_bool::true_value : (ddboost::detail::unspecified_bool_type)0);\
    }

#define BOOST_CONSTEXPR_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE BOOST_CONSTEXPR operator ddboost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &ddboost::detail::unspecified_bool::true_value : (ddboost::detail::unspecified_bool_type)0);\
    }
