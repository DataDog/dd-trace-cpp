...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return ddboost::detail::addrof<T>::get(o, 0);
#else
    return ddboost::detail::addrof<T>::get(ddboost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename ddboost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return ddboost::detail::addressof(o);
}
#endif
