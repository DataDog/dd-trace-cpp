...
public:
    ...
    */
    BOOST_FORCEINLINE explicit reference_wrapper(T& t): t_(ddboost::addressof(t)) {}

#if defined( BOOST_MSVC ) && BOOST_WORKAROUND( BOOST_MSVC, == 1600 )

    BOOST_FORCEINLINE explicit reference_wrapper( T & t, ref_workaround_tag ): t_( ddboost::addressof( t ) ) {}
...
public:
    ...
    */
    template<class Y> reference_wrapper( reference_wrapper<Y> r,
        typename enable_if_c<ddboost::detail::ref_convertible<Y, T>::value,
            ddboost::detail::ref_empty>::type = ddboost::detail::ref_empty() ): t_( r.t_ )
    {
    }
