...
template<class T>
struct has_move_emulation_enabled_impl< ::ddboost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< ddboost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const ddboost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::ddboost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
