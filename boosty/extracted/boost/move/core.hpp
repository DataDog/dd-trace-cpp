...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::ddboost::move_detail::if_c
         < ::ddboost::move_detail::is_class<T>::value
         , T
         , ::ddboost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::ddboost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::ddboost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::ddboost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::ddboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::ddboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::ddboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::ddboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::ddboost::move_detail::enable_if_c
      <  ::ddboost::move_detail::is_lvalue_reference<Ret>::value ||
        !::ddboost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::ddboost::move_detail::enable_if_c
      < !::ddboost::move_detail::is_lvalue_reference<Ret>::value &&
         ::ddboost::has_move_emulation_enabled<T>::value
      , ::ddboost::rv<T>&>::type
         move_return(::ddboost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE T& unrv(::ddboost::rv<T> &rv) BOOST_NOEXCEPT
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      ddboost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::ddboost::move((BASE_TYPE&)(ARG))
   //

   #define BOOST_MOVE_TO_LV(ARG) \
      ::ddboost::move_detail::unrv(ARG)
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::ddboost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::ddboost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::ddboost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::ddboost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< ddboost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::ddboost::move()` due to rvalue reference limitations.
   //!
