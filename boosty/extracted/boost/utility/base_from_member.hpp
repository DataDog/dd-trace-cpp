...
{
    typedef typename ::ddboost::remove_cv<typename
     ::ddboost::remove_reference<T>::type>::type  type;

};  // ddboost::detail::remove_cv_ref
...
struct is_related
    : public ::ddboost::is_same<
     typename ::ddboost::detail::remove_cv_ref<T>::type,
     typename ::ddboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::ddboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::ddboost::disable_if< ::ddboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::ddboost::detail::enable_if_unrelated<base_from_member, T...>::type>
