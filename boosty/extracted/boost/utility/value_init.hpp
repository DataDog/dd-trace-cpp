...
// Note: The implementation of ddboost::value_initialized had to deal with the
// fact that various compilers haven't fully implemented value-initialization.
// The constructor of ddboost::value_initialized<T> works around these compiler
...
#endif
{
  ...
  public :
    ...
    {
      ::ddboost::swap( this->data(), arg.data() );
    }
