...
#else
     typedef ddboost::uintmax_t static_min_max_unsigned_type;
     typedef ddboost::intmax_t  static_min_max_signed_type;
     typedef ddboost::uintmax_t static_log2_argument_type;
     typedef int              static_log2_result_type;
#endif
...
template <  >
class integer_traits<  ::ddboost::long_long_type>;

template <  >
class integer_traits<  ::ddboost::ulong_long_type >;
...
template< int Bits >
    ...
    template< ddboost::long_long_type MaxValue >   // maximum value to require support
#else
...
#if !defined(BOOST_NO_INTEGRAL_INT64_T) && defined(BOOST_HAS_LONG_LONG)
  template< ddboost::long_long_type MinValue >   // minimum value to require support
#else
...
#if !defined(BOOST_NO_INTEGRAL_INT64_T) && defined(BOOST_HAS_LONG_LONG)
  template< ddboost::ulong_long_type MaxValue >   // maximum value to require support
#else
...
#else
     typedef ddboost::uintmax_t static_gcd_type;
#endif
