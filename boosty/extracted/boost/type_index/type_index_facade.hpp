...
public:
    ...
    /// Derived class to not use ddboost::hash_range().
    inline std::size_t hash_code() const BOOST_NOEXCEPT {
        const char* const name_raw = derived().raw_name();
        return ddboost::hash_range(name_raw, name_raw + std::strlen(name_raw));
    }
...
protected:
    ...
    /// ddboost::typeindex::type_id() will call this method, if Derived has same type as ddboost::typeindex::type_index.
    ///
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// ddboost::typeindex::type_id_with_cvr() will call this method, if Derived has same type as ddboost::typeindex::type_index.
    ///
    /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not throw. 
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// ddboost::typeindex::type_id_runtime(const T&) will call this method, if Derived has same type as ddboost::typeindex::type_index.
    ///
