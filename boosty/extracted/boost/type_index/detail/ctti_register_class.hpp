...
/// \brief Contains BOOST_TYPE_INDEX_REGISTER_CLASS macro implementation that uses ddboost::typeindex::ctti_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CLASS                                                                             \
    virtual const ddboost::typeindex::detail::ctti_data& boost_type_index_type_id_runtime_() const BOOST_NOEXCEPT {   \
        return ddboost::typeindex::detail::ctti_construct_typeid_ref(this);                                           \
    }                                                                                                               \
/**/
/// @endcond
