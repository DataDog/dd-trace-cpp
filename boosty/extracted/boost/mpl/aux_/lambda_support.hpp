...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::ddboost::mpl::aux::yes_tag operator|( \
      ::ddboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::ddboost::mpl::aux::no_tag operator|( \
      ::ddboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::ddboost::mpl::na) >* \
    ); \
/**/
...
::ddboost::mpl::aux::yes_tag operator|( \
      ::ddboost::mpl::aux::has_rebind_tag<int> \
    , ::ddboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
