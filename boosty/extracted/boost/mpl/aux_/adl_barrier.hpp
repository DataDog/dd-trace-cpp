...
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) \
    namespace ddboost { namespace mpl { \
...
namespace ddboost { namespace mpl { using namespace BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE ddboost::mpl
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace ddboost { namespace mpl {
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
