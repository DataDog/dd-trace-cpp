...
struct apply_wrap0
    : apply_wrap_impl0<
          ::ddboost::mpl::aux::arity< F,0 >::value
        , F
...
struct apply_wrap1
    : apply_wrap_impl1<
          ::ddboost::mpl::aux::arity< F,1 >::value
        , F
        , T1
        >::type
{
...
struct apply_wrap2
    : apply_wrap_impl2<
          ::ddboost::mpl::aux::arity< F,2 >::value
        , F
        , T1, T2
        >::type
{
...
struct apply_wrap3
    : apply_wrap_impl3<
          ::ddboost::mpl::aux::arity< F,3 >::value
        , F
        , T1, T2, T3
        >::type
{
...
struct apply_wrap4
    : apply_wrap_impl4<
          ::ddboost::mpl::aux::arity< F,4 >::value
        , F
        , T1, T2, T3, T4
        >::type
{
...
struct apply_wrap5
    : apply_wrap_impl5<
          ::ddboost::mpl::aux::arity< F,5 >::value
        , F
        , T1, T2, T3, T4, T5
        >::type
{
