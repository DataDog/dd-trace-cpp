...
ddboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
ddboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
ddboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
ddboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
ddboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
ddboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::ddboost::mpl::if_c<p_type::value,
...
template< typename Pred >
typename assert_arg_type< ddboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          ddboost::mpl::assertion_failed<false>( \
              ddboost::mpl::make_assert_arg< \
                  typename ddboost::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          ddboost::mpl::assertion_failed<false>( \
              ddboost::mpl::make_assert_arg< \
                  typename ddboost::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          ddboost::mpl::assertion_failed<false>( \
              ddboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          ddboost::mpl::assertion<false>::failed( \
              ddboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        ddboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (ddboost::mpl::failed ************ ( ddboost::mpl::assert_relation< \
                  ddboost::mpl::assert_::relations( sizeof( \
                      ddboost::mpl::assert_::arg rel ddboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        ddboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              ddboost::mpl::assert_rel_arg( ddboost::mpl::assert_relation< \
                  ddboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        ddboost::mpl::assertion_failed<(x rel y)>( ddboost::mpl::assert_rel_arg( \
              ddboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&ddboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        ddboost::mpl::assertion_failed<(x rel y)>( (ddboost::mpl::failed ************ ( \
            ddboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&ddboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : ddboost::mpl::assert_ \
{ \
    using ddboost::mpl::assert_::types; \
    static ddboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        ddboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        ddboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
