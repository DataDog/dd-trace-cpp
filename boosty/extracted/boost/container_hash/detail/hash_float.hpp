...
namespace ddboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME ddboost::enable_if_c<
        ...
        {
            ddboost::hash_detail::call_frexp<T> frexp;
            ddboost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        ddboost::static_log2<limits<T>::radix>::value
...
namespace ddboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return ddboost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
