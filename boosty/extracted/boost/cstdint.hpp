...
//   29 Jun 00  Reimplement to avoid including stdint.h within namespace ddboost
...
#    endif
     ...
     typedef  ::ddboost::long_long_type            intmax_t;
     typedef  ::ddboost::ulong_long_type   uintmax_t;
     typedef  ::ddboost::long_long_type            int64_t;
     typedef  ::ddboost::long_long_type            int_least64_t;
     typedef  ::ddboost::long_long_type            int_fast64_t;
     typedef  ::ddboost::ulong_long_type   uint64_t;
     typedef  ::ddboost::ulong_long_type   uint_least64_t;
     typedef  ::ddboost::ulong_long_type   uint_fast64_t;
...
#   define INT8_C(value) static_cast<ddboost::int8_t>(value)
#   define UINT8_C(value) static_cast<ddboost::uint8_t>(value##u)
#  endif

//  16-bit types  -----------------------------------------------------------//

#  if (USHRT_MAX == 0xffff) && !defined(INT16_C)
#   define INT16_C(value) static_cast<ddboost::int16_t>(value)
#   define UINT16_C(value) static_cast<ddboost::uint16_t>(value##u)
#  endif
