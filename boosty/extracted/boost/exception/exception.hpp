...
#include  <memory>
namespace ddboost { namespace exception_detail { using std::shared_ptr; } }
#else
namespace ddboost { template <class T> class shared_ptr; }
namespace ddboost { namespace exception_detail { using ddboost::shared_ptr; } }
#endif
...
ddboost
    ...
    exception_detail
        ...
        ddboost::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing ddboost::exception.
        ...
        friend ddboost::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline ddboost::source_location get_exception_throw_location( exception const & x )
            {
