...
namespace ddboost { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::ddboost::optional<T> >
{
  typedef T type;
};

}} // namespace ddboost::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    typedef typename ddboost::remove_const<T>::type unqualified_value_type;
  ...
  protected:
    ...
    BOOST_NOEXCEPT_IF(::ddboost::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
        construct( ddboost::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(ddboost::forward<Expr>(expr),tag);
    }
    ...
    BOOST_NOEXCEPT_IF(::ddboost::is_nothrow_move_constructible<T>::value && ::ddboost::is_nothrow_move_assignable<T>::value)
    {
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( ddboost::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( ddboost::move(val) );
      else construct( ddboost::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(ddboost::forward<Expr>(expr),tag);
      else construct(ddboost::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) unqualified_value_type( ddboost::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) unqualified_value_type( ddboost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, ddboost::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) unqualified_value_type( ddboost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, ddboost::forward<Arg>(arg)) ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       ddboost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) unqualified_value_type(ddboost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( ddboost::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) unqualified_value_type(ddboost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_or_tag
  : ddboost::conditional< ddboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type>::value
                     || ddboost::is_same<BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type, none_t>::value
                     || ddboost::is_same<BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type, in_place_init_t>::value
                     || ddboost::is_same<BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type, in_place_init_if_t>::value,
    ddboost::true_type, ddboost::false_type>::type
{};

template <typename T, typename U>
struct has_dedicated_constructor
  : ddboost::disjunction<is_optional_or_tag<U>, ddboost::is_same<T, BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type> >
{};

template <typename U>
struct is_in_place_factory
  : ddboost::disjunction< ddboost::is_base_of<ddboost::in_place_factory_base, BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type>,
                        ddboost::is_base_of<ddboost::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME ddboost::decay<U>::type> >
{};
...
struct is_factory_or_constructible_to_T
  : ddboost::disjunction< is_in_place_factory<U>, ddboost::is_constructible<T, U&&> >
{};

template <typename T, typename U>
struct is_optional_constructible : ddboost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_factory_or_constructible_to_T : ddboost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : ddboost::true_type
{};
...
struct is_opt_assignable
  : ddboost::conjunction<ddboost::is_convertible<U&&, T>, ddboost::is_assignable<T&, U&&> >
{};
...
template <typename T, typename U>
struct is_opt_assignable : ddboost::is_convertible<U, T>
{};
...
struct is_factory_or_opt_assignable_to_T
  : ddboost::disjunction< is_in_place_factory<U>, is_opt_assignable<T, U> >
{};
...
struct optional_uses_direct_storage_for
  : ddboost::conditional<(ddboost::is_scalar<T>::value && !ddboost::is_const<T>::value && !ddboost::is_volatile<T>::value)
                      , ddboost::true_type, ddboost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) ddboost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base(optional_detail::init_value_tag(), ddboost::forward<T>(val))
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, ddboost::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME ddboost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME ddboost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
    {
      if ( rhs.is_initialized() )
        this->construct( ddboost::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME ddboost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(ddboost::forward<Expr>(expr),ddboost::addressof(expr))
    {}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,ddboost::addressof(expr)) {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME ddboost::enable_if<optional_detail::is_optional_val_assign_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(ddboost::forward<Expr>(expr),ddboost::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,ddboost::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    BOOST_DEDUCED_TYPENAME ddboost::enable_if<ddboost::is_same<T, BOOST_DEDUCED_TYPENAME ddboost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( ddboost::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    {
      this->emplace_assign( ddboost::forward<Args>(args)... );
    }

    template<class... Args>
    explicit optional ( in_place_init_t, Args&&... args )
    : base( in_place_init, ddboost::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, ddboost::forward<Args>(args)... )
    {}
    ...
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( ddboost::forward<Arg>(arg) );
     }
    ...
    reference_type_of_temporary_wrapper operator *() && { return ddboost::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    template <typename F>
    optional<typename ddboost::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename ddboost::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename ddboost::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(ddboost::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename ddboost::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename ddboost::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename ddboost::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(ddboost::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME ddboost::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME ddboost::decay<T>::type>(ddboost::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME ddboost::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME ddboost::decay<T>::type>(cond,ddboost::forward<T>(v));
}
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output ddboost::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
