...
class tc_optional_base : public optional_tag
{
  ...
  protected :
    ...
    {
      m_storage = value_type( ddboost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       m_storage = value_type( ddboost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       ddboost_optional_detail::construct<value_type>(factory, ddboost::addressof(m_storage));
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, typed_in_place_factory_base const* )
     {
       factory.apply(ddboost::addressof(m_storage)) ;
       m_initialized = true ;
     }
    ...
    {
      m_storage = value_type(ddboost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         m_storage = value_type(ddboost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
    ...
    pointer_const_type get_ptr_impl() const { return ddboost::addressof(m_storage); }
    pointer_type       get_ptr_impl()       { return ddboost::addressof(m_storage); }
