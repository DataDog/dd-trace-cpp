...
struct is_type_trivially_copyable
  : ddboost::conditional<(ddboost::has_trivial_copy_constructor<T>::value &&
                        ddboost::has_trivial_move_constructor<T>::value &&
                        ddboost::has_trivial_destructor<T>::value &&
                        ddboost::has_trivial_move_assign<T>::value &&
                        ddboost::has_trivial_assign<T>::value),
...
struct optional_uses_direct_storage_for_
  : ddboost::conditional< (is_type_trivially_copyable<T>::value && BOOST_OPTIONAL_DETAIL_HAS_TRIVIAL_CTOR(T)) ||
                        (ddboost::is_scalar<T>::value && !ddboost::is_const<T>::value && !ddboost::is_volatile<T>::value)
                      , ddboost::true_type, ddboost::false_type>::type
{};
#else
template <typename T>
