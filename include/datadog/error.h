...
// The `Error` struct represents a particular kind of failure together with a
// contextual message describing the failure.
//
...
//
// `Error` is the error type used by the `Expected` class template. See
// `expected.h`.
