...
- [check-tidy](check-tidy) runs **clang-tidy-14** (pinned) in the CI container.
  It configures CMake inside the container and fails on findings. Do not point
  it at a host `compile_commands.json`.
